    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(choices=[('PETROL', 'Petrol'), ('HYBRID', 'Hybrid'),
                                                        ('ELECTRIC', 'Electric')], max_length=100)),
                ('transmission_type', models.CharField(choices=[('AUTO', 'Automatic'),
                                                                ('MANUAL', 'Manual')], max_length=100)),
